    ...
    <section class="content">
      <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Spending Master Website Karawang</h3>
              <a class="btn btn-danger btn-sm pull-right" data-toggle="modal" data-target="#myModal"> <i class=" fa fa-plus"></i> Add Spending</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		?>
                <tr>
                  ...
                  <td>Rp. <?php echo number_format($u->besar); ?></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="form-horizontal" action="<?php echo base_url('spending/tambah') ?>" method="post">
              <div class="box-body">
